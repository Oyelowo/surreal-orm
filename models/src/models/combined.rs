...
pub struct Student {
    ...
    #[surreal_orm(
        // type="array(int)",
        // type_ = "geometry(feature, point, collection, polygon)",
        // value = "we()",
...
#[derive(Node, TypedBuilder, Serialize, Deserialize, Debug, Clone)]
#[serde(rename_all = "camelCase")]
#[surreal_orm(table_name = "studentt")]
pub struct Studentt {
    id: SurrealId<Student, String>,

    first_name: String,
    last_name: String,
    #[surreal_orm(define_fn = "define_age")]
    age: u8,

    // Even if ypu dont list the type for all links, the types are autogenerated at compile time
    // becuase I have enough info from the annotation to derive it
    #[surreal_orm(link_self = "Studentt", type_ = "record<studentt>")]

...
export class Engine extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.EngineSpec | undefined>;
    /**
     * EngineStatus defines the observed state of the Longhorn engine
     */
    public readonly status!: pulumi.Output<outputs.longhorn.v1beta2.EngineStatus | undefined>;

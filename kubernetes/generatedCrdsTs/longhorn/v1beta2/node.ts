...
export class Node extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.NodeSpec | undefined>;
    /**
     * NodeStatus defines the observed state of the Longhorn node
     */
    public readonly status!: pulumi.Output<outputs.longhorn.v1beta2.NodeStatus | undefined>;

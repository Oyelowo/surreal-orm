...
export class HTTPRoute extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:policy.linkerd.io/v1alpha1:HTTPRoute';
     ...
     */
    public readonly status!: pulumi.Output<outputs.policy.v1alpha1.HTTPRouteStatus | undefined>;

...
export class Server extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:policy.linkerd.io/v1beta1:Server';
    ...
    constructor(name: string, args?: ServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["spec"] = args ? (args.spec ? pulumi.output(args.spec).apply(inputs.policy.v1beta1.serverSpecArgsProvideDefaults) : undefined) : undefined;
        } else {

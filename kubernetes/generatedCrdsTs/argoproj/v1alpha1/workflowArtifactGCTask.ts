...
export class WorkflowArtifactGCTask extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkflowArtifactGCTask {
        return new WorkflowArtifactGCTask(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:argoproj.io/v1alpha1:WorkflowArtifactGCTask';
     ...
     */
    constructor(name: string, args?: WorkflowArtifactGCTaskArgs, opts?: pulumi.CustomResourceOptions) {

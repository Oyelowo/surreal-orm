...
export class Stream extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:jetstream.nats.io/v1beta2:Stream';
    ...
    public readonly spec!: pulumi.Output<outputs.jetstream.v1beta2.StreamSpec | undefined>;
    public readonly status!: pulumi.Output<outputs.jetstream.v1beta2.StreamStatus | undefined>;
    ...
    constructor(name: string, args?: StreamArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["spec"] = args ? (args.spec ? pulumi.output(args.spec).apply(inputs.jetstream.v1beta2.streamSpecArgsProvideDefaults) : undefined) : undefined;

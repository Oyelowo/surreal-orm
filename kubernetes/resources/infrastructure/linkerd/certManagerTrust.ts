import { certManagerControllerProvider } from './../cert-manager/certManagerTrust';
...
export const linkerdCertManagertrust = new cmt.v1alpha1.Bundle(LINKERD_IDENTITY_TRUST_ROOTS_SECRET_NAME, {
    metadata: {

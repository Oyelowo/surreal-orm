...
export class TrafficSplit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:split.smi-spec.io/v1alpha1:TrafficSplit';
    ...
    public readonly apiVersion!: pulumi.Output<"split.smi-spec.io/v1alpha1" | undefined>;
    public readonly kind!: pulumi.Output<"TrafficSplit" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    public readonly spec!: pulumi.Output<outputs.split.v1alpha1.TrafficSplitSpec | undefined>;
    ...
    constructor(name: string, args?: TrafficSplitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            resourceInputs["apiVersion"] = "split.smi-spec.io/v1alpha1";
...
export interface TrafficSplitArgs {
    apiVersion?: pulumi.Input<"split.smi-spec.io/v1alpha1">;
    kind?: pulumi.Input<"TrafficSplit">;
    metadata?: pulumi.Input<ObjectMeta>;
    spec?: pulumi.Input<inputs.split.v1alpha1.TrafficSplitSpecArgs>;
}

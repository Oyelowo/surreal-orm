...
impl User {
    ...
    pub async fn find_or_create_for_oauth(
        ...
        let checkForExistingAccount = doc! {
        ...
        user.save(db, Some(checkForExistingAccount)).await?;

...
pub struct StudentInline {
    id: SurrealId<StudentInline, String>,
    first_name: String,
    last_name: String,
    #[surreal_orm(
        type = "int",
        ...
        permissions = "for_([CrudType::Create, CrudType::Delete]).where_(StudentInline::schema().firstName.is(\"Oyelowo\"))",
        // define = "define_age()"
    )]
    age_inline_expr: u8,
    ...
    #[surreal_orm(link_self = "StudentInline", type = "record(student_inline)")]
    best_friend: LinkSelf<StudentInline>,
    ...
    #[surreal_orm(relate(model = "StudentInlineWritesBook", connection = "->writes->book"))]
    #[serde(skip_serializing)]
    written_books: Relate<Book>,

    #[surreal_orm(relate(model = "StudentInlineWritesBlog", connection = "->writes->blog"))]
    #[serde(skip_serializing)]
...
pub type StudentInlineWritesBook = Writes<StudentInline, Book>;
pub type StudentInlineWritesBlog = Writes<StudentInline, Blog>;

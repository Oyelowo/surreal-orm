...
#[derive(Debug, Clone, PartialEq, JsonSchema, Deserialize, Serialize, Surrealize, Inspect, Default)]
...
struct Alien {
    ...
    #[serde(rename = "created")]
    created: DateTime<Utc>,
    #[serde(rename = "line_polygon")]
    line_polygon: LineString<f64>,
    #[serde(rename = "life_expectancy")]
    life_expectancy: Duration,
    #[serde(rename = "territory_area")]
    territory_area: Polygon<f64>,
    #[serde(rename = "home")]
    home: Point<f64>,
    #[serde(rename = "tags")]
    tags: Vec<String>,
    ...
    #[serde(rename = "space_ships")]
    space_ships: LinkMany<SpaceShip>,
    #[serde(rename = "planets_to_visit")]
...
```rust
#[tokio::test]
async fn test_create_with_set() -> SurrealdbOrmResult<()> {

...
impl FieldsMapper {
    ...
    pub(crate) fn get_struct_types_and_fields(
        ...
        let mut field_store = FieldsMapper::default();

        fields
            .into_iter()
            .enumerate()
            .for_each(|(index, field_receiver)| {
                Self::create_fields_types_and_values(
                    field_receiver,
                    struct_level_casing,
                    index,
                    &mut self,
    ...
    pub(crate) fn create_fields_types_and_values(
        ...
        let FieldFormat {
            ...
            ident,
            serialized_as_ident,
        } = Self::get_field_str_and_ident(&field_case, &field_identifier_string, field_receiver);
        ...
        store
            ...
            .push(quote!(#serialized_as_ident));
    }
    ...
    pub(crate) fn get_field_str_and_ident(
        ...
        let field = Self::to_case_string(field_case, field_identifier_string);

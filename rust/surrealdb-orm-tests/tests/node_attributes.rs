...
pub struct AlienWithExplicitAttributes {
    #[surrealdb(type = "record(alien_with_explicit_attributes)")]
    id: sql::Thing,
    ...
    #[surrealdb(type = "datetime")]
    created: DateTime<Utc>,

    #[surrealdb(type = "duration")]
    life_expectancy: Duration,

    #[surrealdb(type = "geometry(feature)")]
    territory_area: Polygon,

    #[surrealdb(type = "geometry(feature)")]
    home: Point,

    #[surrealdb(content_type = "string")]
    // Full definitions. This also works.
    // #[surrealdb(type = "array", content_type = "string")]
    tags: Vec<String>,

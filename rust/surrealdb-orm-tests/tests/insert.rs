...
//     let created_alien_with_fetched_links = insert(unsaved_alien.clone())
//         .return_one_and_fetch_non_null(db.clone(), vec![spaceShips])
//         .await?;
//
//     let ref created_alien_with_fetched_links = created_alien_with_fetched_links.unwrap();
...
//             .return_many_and_fetch_all(db.clone(), vec![spaceShips, age, created])
//             .await;
...
//         // .return_many_and_fetch_all(db.clone(), vec![])
//         // .return_many_and_fetch_all(db.clone(), Alien::get_linked_fields())
//         .load_all_link_many_values()
//         .return_one(db.clone())
//         .await?;
